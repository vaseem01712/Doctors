    ...
    >
        ...
        <div class="container-shell flex h-[76px] items-center justify-between gap-4">
            ...
            <nav class="hidden items-center gap-1 xl:flex">
                ...
                >
                    <span
                        class="<?php echo e(request()->routeIs('home') ? 'text-primary-700' : 'text-slate-600 group-hover:text-navy-900'); ?>"
                    >
                        Home
                    </span>
                ...
                >
                    <span class="<?php echo e(request()->routeIs('doctors.*') ? 'text-primary-700' : 'text-slate-600 group-hover:text-navy-900'); ?>">
                        Doctors
                    </span>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('doctors.*')): ?>
                        <span class="absolute bottom-1.5 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-primary-600"></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </a>
                ...
                <a
                    ...
                    class="group relative whitespace-nowrap rounded-full px-4 py-2.5 text-sm font-bold transition hover:bg-white/70"
                >
                    <span class="<?php echo e(request()->routeIs('services.*') ? 'text-primary-700' : 'text-slate-600 group-hover:text-navy-900'); ?>">
                        Services
                    </span>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('services.*')): ?>
                        <span class="absolute bottom-1.5 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-primary-600"></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </a>
                ...
                <a
                    ...
                    class="group relative whitespace-nowrap rounded-full px-4 py-2.5 text-sm font-bold transition hover:bg-white/70"
                >
                    <span class="<?php echo e(request()->routeIs('specialties.*') ? 'text-primary-700' : 'text-slate-600 group-hover:text-navy-900'); ?>">
                        Specialties
                    </span>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('specialties.*')): ?>
                        <span class="absolute bottom-1.5 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-primary-600"></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </a>
                ...
                <a
                    ...
                    class="group relative whitespace-nowrap rounded-full px-4 py-2.5 text-sm font-bold transition hover:bg-white/70"
                >
                    <span class="<?php echo e(request()->routeIs('blog.*') ? 'text-primary-700' : 'text-slate-600 group-hover:text-navy-900'); ?>">
                        Insights
                    </span>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('blog.*')): ?>
                        <span class="absolute bottom-1.5 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-primary-600"></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </a>
                ...
                <a
                    ...
                    class="group relative whitespace-nowrap rounded-full px-4 py-2.5 text-sm font-bold transition hover:bg-white/70"
                >
                    <span class="<?php echo e(request()->routeIs('contact') ? 'text-primary-700' : 'text-slate-600 group-hover:text-navy-900'); ?>">
                        Contact
                    </span>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('contact')): ?>
                        <span class="absolute bottom-1.5 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-primary-600"></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </a>
            ...
            <div class="hidden items-center gap-2.5 xl:flex">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    ...
                    <a
                        href="<?php echo e(auth()->user()->isDoctor() ? route('doctor.dashboard') : route('dashboard')); ?>"
                ...
                <?php else: ?>
                    ...
                    <a
                        href="<?php echo e(route('doctor.login')); ?>"
        ...
        >
            ...
            <nav class="grid gap-2">
                ...
                <a
                    href="<?php echo e(route('home')); ?>"
                    class="flex items-center justify-between rounded-2xl px-5 py-3.5 font-bold transition <?php echo e(request()->routeIs('home') ? 'bg-primary-50 text-primary-700' : 'text-slate-700 hover:bg-slate-50'); ?>"
                >
                    Home
                    <span>→</span>
                </a>
                ...
                <a
                    href="<?php echo e(route('doctors.index')); ?>"
                    class="flex items-center justify-between rounded-2xl px-5 py-3.5 font-bold transition <?php echo e(request()->routeIs('doctors.*') ? 'bg-primary-50 text-primary-700' : 'text-slate-700 hover:bg-slate-50'); ?>"
                >
                    Doctors
                    <span>→</span>
                </a>
                ...
                <a
                    href="<?php echo e(route('services.index')); ?>"
                    class="flex items-center justify-between rounded-2xl px-5 py-3.5 font-bold transition <?php echo e(request()->routeIs('services.*') ? 'bg-primary-50 text-primary-700' : 'text-slate-700 hover:bg-slate-50'); ?>"
                >
                    Services
                    <span>→</span>
                </a>
                ...
                <a
                    href="<?php echo e(route('specialties.index')); ?>"
                    class="flex items-center justify-between rounded-2xl px-5 py-3.5 font-bold transition <?php echo e(request()->routeIs('specialties.*') ? 'bg-primary-50 text-primary-700' : 'text-slate-700 hover:bg-slate-50'); ?>"
                >
                    Specialties
                    <span>→</span>
                </a>
                ...
                <a
                    href="<?php echo e(route('blog.index')); ?>"
                    class="flex items-center justify-between rounded-2xl px-5 py-3.5 font-bold transition <?php echo e(request()->routeIs('blog.*') ? 'bg-primary-50 text-primary-700' : 'text-slate-700 hover:bg-slate-50'); ?>"
                >
                    Insights
                    <span>→</span>
                </a>
                ...
                <a
                    href="<?php echo e(route('contact')); ?>"
                    class="flex items-center justify-between rounded-2xl px-5 py-3.5 font-bold transition <?php echo e(request()->routeIs('contact') ? 'bg-primary-50 text-primary-700' : 'text-slate-700 hover:bg-slate-50'); ?>"
                >
                    Contact
                    <span>→</span>
                </a>
...
</header><?php /**PATH C:\ITprojects\New folder\resources\views/components/header.blade.php ENDPATH**/ ?>